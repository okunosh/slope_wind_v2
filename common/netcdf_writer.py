        ...
        ds = xr.Dataset(
            ...
            coords={
                "altitude": (
                    ...
                    {"units": "m", "description": "Altitude"}
                ),
                "time": (
                    "time", self.time,
                    {"units": "s", "description": "Time passed from start"}
                ),
            },
            attrs={
                "title": self.title,
