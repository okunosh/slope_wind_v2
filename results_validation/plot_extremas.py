...
def plot_extrema_scatter_comparison(
    ...
    ax1.scatter(times, extrema_old_u["z_max"], c=extrema_old_u["max_val"],
                cmap=cmap, norm=norm, marker=m_old, alpha=0.6,
                s=marker_size_old, edgecolors=ec_old, linewidths=lw_old)
    ...
    ax1.scatter(times, extrema_new_u["z_max"], c=extrema_new_u["max_val"],
                cmap=cmap, norm=norm, marker=m_new,
                s=marker_size_new, edgecolors=ec_new, linewidths=lw_new)
    ...
    plt.subplots_adjust(left=0.1, right=0.9, hspace=0.15)
